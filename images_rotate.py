...
ANGLE_START = -config.MAX_ANGLE         # Начальный угол поворота (градусы)
ANGLE_END = config.MAX_ANGLE            # Конечный угол поворота (градусы)
...
def main():
    ...
    for filename in os.listdir(RAW_DIR):
        ...
        output_subdir = os.path.join(IMG_DIR, ("rotate_" + name))
